...
namespace Fiorello_PB101.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult IncrementProductCount(int? id)
        {
            ...
            List<BasketVM> basketDatas = GetBasketData();
            ...
            UpdateBasketCookie(basketDatas);
        ...
        private List<BasketVM> GetBasketData()
        {
            return _accessor.HttpContext.Request.Cookies["basket"] is not null
                ? JsonConvert.DeserializeObject<List<BasketVM>>(_accessor.HttpContext.Request.Cookies["basket"])
                : new List<BasketVM>();
        }

        private void UpdateBasketCookie(List<BasketVM> basketDatas)
        {
            _accessor.HttpContext.Response.Cookies.Append("basket", JsonConvert.SerializeObject(basketDatas));
        }
